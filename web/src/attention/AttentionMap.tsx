...
interface AttentionMapProps {
  ...
  openableUnitIds?: ReadonlySet<string>;
  compact?: boolean;
}

export function AttentionMap({ landscape, units, onOpen, theme = 'dark', touchedUnitIds, openableUnitIds, compact = false }: AttentionMapProps) {
